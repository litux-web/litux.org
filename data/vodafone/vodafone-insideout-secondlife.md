...
{{{image:vodafone/vodafone-insideout-secondlife.jpeg:Vodafone InsideOut SecondLife}}}
{{{image:vodafone/vodafone-insideout-secondlife-1.jpeg:Vodafone InsideOut SecondLife}}}
{{{image:vodafone/vodafone-insideout-secondlife-2.jpeg:Vodafone InsideOut SecondLife}}}

The cat is out of the bag! [Vodafone InsideOut](https://web.archive.org/web/20080418100131/http://secondlife.vodafone.com/) on [SecondLife](https://secondlife.com).

You know what it’s like. You’re chatting to your robot friend while skydiving from a floating marshmallow castle when you realise you’re late for work.
...
Vodafone InsideOut got a patent registered for the transparent two-way communication mechanism for voice and messaging between the customers: [Patent EU DE102007025052 (A1) · Issued Dec 4, 2008](https://worldwide.espacenet.com/publicationDetails/biblio?DB=EPODOC&adjacent=true&locale=en_EP&FT=D&date=20081204&CC=DE&NR=102007025052A1&KC=A1)
> Data connection establishing method for use between two subscribers in network system, involves establishing data connection to communication terminal based on receiving of signaling information in telephone network
Data connection establishing method for use between two subscribers in network system, involves establishing data connection to communication terminal based on receiving of signaling information in telephone network
...
* [Telecom Paper :: Vodafone launches Second Life call service](https://web.archive.org/web/20080518200337/http://www.telecompaper.com/news/article.aspx?id=186622&amp;#038;nr=&amp;#038;type=&amp;#038;yr=)
